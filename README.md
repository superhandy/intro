...
`handy` (or [handy-mode](https://github.com/superhandy/handy-mode))
is a set of keyboard shortcuts that you could use in any text
editor. The idea is to offer a progressive way to convert your current
keyboard shortcuts to a more easy to use set of shortcuts.
...
* [Emacs](https://github.com/superhandy/handy-mode)
